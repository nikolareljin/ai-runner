...
assert_contains "$docker_same" "Model pull completed, but this Ollama build does not support 'ollama export'." "docker_same: export unsupported message"
assert_contains "$docker_same" "only available in the Docker runtime store at ${models_dir}." "docker_same: runtime model store path"
...
assert_contains "$local_same" "Model pull completed, but this Ollama build does not support 'ollama export'." "local_same: export unsupported message"
assert_contains "$local_same" "only available through the running local Ollama server." "local_same: local server availability message"
