...
## Unreleased
- Docs: `burn-iso` was renamed to `iso-forge` on GitHub. The About dialog link and the tool-suite Pages links now name the new repository. The tool itself, `isoforge`, is unchanged.
